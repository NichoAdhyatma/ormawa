...
<template>
    ...
    <div
        class="relative flex items-top justify-center min-h-screen bg-base-100 sm:items-center sm:pt-0">
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-base-200 grid grid-cols-1 md:grid-cols-2">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold">
                            <a href="https://laravel.com/docs">Himpunan Mahasiswa (HIMA)</a>
                        </div>
                    </div>
                    ...
                    <div class="ml-12">
                        <div class="mt-2 text-sm">
                            ...
                            new
                            to the framework or have previous experience, we recommend reading all of the documentation
                            from
                            beginning to end.
                        </div>
                ...
                <div class="p-6 border-t border-base-300 md:border-t-0 md:border-l">
                    <div class="flex items-center">
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8">
                            <path
                        ...
                        <div class="ml-4 text-l leading-7 font-semibold">
                            <a href="https://laracasts.com">Badan Eksekutif Mahasiswa (BEM)</a>
                        </div>
                    </div>
                ...
                <div class="p-6 border-t border-base-300">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold">
                            <a href="https://tailwindcss.com/">Unit Kegiatan Mahasiswa (UKM) </a>
                        </div>
                    </div>
                    ...
                    <div class="ml-12">
                        <div class="mt-2 text-sm">
                            ...
                            doesn't
                            get in your way. You'll be amazed how easily you can build and maintain fresh, modern
                            designs
                ...
                <div class="p-6 border-t border-base-300 md:border-l">
                    <div class="flex items-center">
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8">
                            <path
                    ...
                    <div class="ml-12">
                        <div class="mt-2 text-sm">
                            ...
                            support
                            for user email verification and resetting forgotten passwords. So, you're free to get
                            started
