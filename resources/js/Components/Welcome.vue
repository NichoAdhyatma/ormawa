...
<template>
    <div>
        <div class="p-6 sm:px-20 bg-base-200 border-b border-base-300">
            ...
            <div class="mt-4">
                Welcome to Ormawa dashboard you can manage your profile
                account here...
            </div>
        </div>
        ...
        <div class="bg-base-200 grid grid-cols-1 md:grid-cols-2">
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 text-lg leading-7 font-semibold">
                        <a href="https://laravel.com/docs">Manage Account</a>
                    </div>
                </div>
            ...
            <div class="p-6 border-t border-base-300 md:border-t-0 md:border-l">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 text-l leading-7 font-semibold">
                        <a href="https://laracasts.com">Manage your Organization</a>
                    </div>
                </div>
            ...
            <div class="p-6 border-t border-base-300">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 text-lg leading-7 font-semibold">
                        <a href="https://tailwindcss.com/">Convert your achivement into SKS</a>
                    </div>
                </div>
            ...
            <div class="p-6 border-t border-base-300 md:border-l">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 text-lg leading-7 font-semibold">
                        Develop Soft Skill and Hard Skill
                    </div>
                </div>
