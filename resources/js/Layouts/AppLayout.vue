...
<template>
    <div :data-theme="theme" class="drawer">
        ...
        <div class="drawer-content">
            <!-- Page content here -->
            <div class="bg-base-100 drawer min-h-screen flex items-center justify-center">

                <Head :title="title" />
                <div
                    class="bg-base-200 flex-1 flex flex-col space-y-5 lg:space-y-0 lg:flex-row lg:space-x-10 min-h-screen sm:p-6">
                    <!-- Navigation -->
                    <div
        ...
        <div class="drawer-side">
            ...
            <ul class="menu p-4 w-80 bg-base-100 text-base-content">
                ...
                <label for="my-drawer" class="btn btn-circle mb-5">
